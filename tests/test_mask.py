...
def test_get_mask_card_number_invalid(invalid_card_number: str, error_msg: str) -> None:
...
@pytest.mark.parametrize(
    "invalid_account_number, error_msg",
    [
...
def test_get_mask_account_invalid(invalid_account_number: str, error_msg: str) -> None:
    with pytest.raises(ValueError, match=error_msg):
